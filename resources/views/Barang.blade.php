...
<button class="pushable">
  <span class="front">
    <a href="tambah"style="color:white;">Tambah Barang</a> 
  </span>
</button>
        <div class="card-body">
              ...
              <?php $no=1;?>
                  ...
                  <tr>
                    ...
                    <td>{{$Barang->id}}</td>
                     ...
                     ||   
                     <a href="{{url('Barang/'.$Barang->id.'/edit')}}"><span class="badge bg-primary" style="color:white;">Edit</span></a> </td>
              ...
              <?php $no=1;?>
                  ...
                  <tr>
                    ...
                    <td>{{$no++}}</td>
                      ...
                      <td>
                      {{-- <a href="#"><span class="badge bg-primary">Delete</span></a>  --}}
                     <form action="{{'bid'.$Bid->id}}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
                        <button type="submit" class="btn btn-danger badge">Delete</button>
                     </form>
